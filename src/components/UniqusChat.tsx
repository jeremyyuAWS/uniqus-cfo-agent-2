...
interface UniqusChatProps {
  selectedNode: string | null;
}

export const UniqusChat: React.FC<UniqusChatProps> = ({ selectedNode }) => {
  const [messages, setMessages] = useState<{ role: string; content: string }[]>([
    { 
      role: 'agent', 
      content: 'Hello, I am your Uniqus Super Agent. I can help you understand how our agents work together and answer questions about finance operations. What would you like to know?' 
    }
  ]);
  ...
  const getAIResponse = (message: string) => {
    ...
    if (lowerMessage.includes('agent') && lowerMessage.includes('work together')) {
      return 'Our agents work together through a process called orchestration. The Uniqus framework allows agents to share context, handoff tasks, and collaborate on complex workflows. For example, the Cash-Flow Forecaster might identify a liquidity issue and alert the AR Collections Prioritizer to focus on specific high-value invoices.';
